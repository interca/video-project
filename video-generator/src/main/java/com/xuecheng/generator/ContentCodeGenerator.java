...
public class ContentCodeGenerator {
	...
	//数据库密码
	private static final String DATA_SOURCE_PASSWORD  = "13538026482";
	//生成的表
...
//			"mq_message_history"
	...
	public static void main(String[] args) {
		...
		//生成路径
		gc.setOutputDir(System.getProperty("user.dir") + "/video-generator/src/main/java");
		gc.setAuthor("itcast");
		gc.setOpen(false);
		...
		dsc.setUrl("jdbc:mysql://localhost:3306/video_" + SERVICE_NAME
